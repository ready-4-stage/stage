...
CREATE SEQUENCE IF NOT EXISTS LESSON_ID_SEQUENCE START WITH 1;

CREATE SEQUENCE IF NOT EXISTS LESSON_TYPE_ID_SEQUENCE START WITH 1;
...
VALUES ((SELECT NEXT VALUE FOR ROOM_ID_SEQUENCE), 'A1', 'large groups');

-- ROOM 2
INSERT INTO ROOM(ID, NAME, SUITABILITY)
VALUES ((SELECT NEXT VALUE FOR ROOM_ID_SEQUENCE), 'B1', 'drums');

-- Lesson Type 1
INSERT INTO LESSON_TYPE (ID, DESCRIPTION)
VALUES ((SELECT NEXT VALUE FOR LESSON_TYPE_ID_SEQUENCE), 'Introduction');

-- Lesson Type 2
INSERT INTO LESSON_TYPE (ID, DESCRIPTION)
VALUES ((SELECT NEXT VALUE FOR LESSON_TYPE_ID_SEQUENCE), 'Band');
